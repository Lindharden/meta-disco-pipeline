...
SRC_URI = "git://github.com/Lindharden/MARIO.git;protocol=https;branch=yocto-test;rev=ef755fa4a94db47921bfa8cebe658f27ace8c945"
...
do_install() {
    ...
    install -m 0644 ${WORKDIR}/git/test.png ${D}/usr/share/pipeline
}
